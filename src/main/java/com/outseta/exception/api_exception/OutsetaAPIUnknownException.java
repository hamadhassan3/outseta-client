...
/**
 * This class is used to represent an exception that occurred due to an unknown
 * request to the Outseta API.
 */
public class OutsetaAPIUnknownException extends OutsetaAPIException {

    /**
     * This constructor is used to create a new OutsetaAPIUnknownException
     * object.
     ...
     */
    public OutsetaAPIUnknownException(final String reason, final String url,
                                      final String payload,
                                      final Map<String, Object> parameters,
                                      final Map<String, String> headers,
                                      final Integer responseCode,
                                      final Exception triggeredBy) {
        super(reason, url, payload, parameters, headers, responseCode,
                triggeredBy);
    }
}

...
/**
 * This class is used to represent an exception that occurred due to a failed
 * request to the Outseta API.
 */
public class OutsetaAPIFailedException extends OutsetaAPIException {

    /**
     * This constructor is used to create a new OutsetaAPIFailedException
     * object.
     ...
     */
    public OutsetaAPIFailedException(final String reason, final String url,
